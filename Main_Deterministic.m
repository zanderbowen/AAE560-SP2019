...
%   It does so in a deterministic manner.                                 %
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%-------------------------------------------------------------------------%
...
%	Running work orders down to machine level and executing.  We send each 
%   work order through a timer function that moves the job shop assigned
%   work by 1 time unit each run, for a specified number of hours
...
%   Plot the master schedule to see scheduling update
if plot_master==1
    figure;
